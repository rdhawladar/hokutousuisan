...
--
-- Host: localhost
-- Generation Time: Oct 30, 2017 at 07:32 PM
...
(1, 'Admin', 'admin@gmail.com', '$2y$10$nvmX4nYbEA.HZ5qvqNmUoeWSRJs8VGyWt8saJ/AMarjdxfJQ150vy', 'PIg8sIawn2AinHy9S8iwBQzgk6PjffKW4s2dDoeYn1Pnx8XTSCdaDj8D3iXq', 'admin', 'ACTIVE', '2017-10-27 12:41:59', '2017-10-27 06:41:59');
...
(0, 'main', 'main', 'すべての商品', '20171018064232_banner_cat.png', '20171013073408_banner01.jpg', '北海道の魚貝販売コーナーや、各イベントコーナーなどを一覧で紹介しています', '2017-10-26 12:26:35', '2017-10-26 06:26:35'),
...
(2, 'cat', 'cat_2', '魚卵', '20171018055436_Banner4.png', '20171013114158_Banner06.jpg', '新鮮な助宗鱈から取り出した卵を、 定温でじっくりと塩蔵し、出来上がっ た「塩たらこ」は、プチプチとした食 感と外皮の薄さで口あたりもよく、 あつあつのご飯にも酒の肴にもよく合 う一品です。  また、スパゲティーや、焼き魚卵に しても食感、味ともにお箸がすすむ 「北海道産塩たらこ」です', '2017-10-26 12:24:01', '2017-10-26 06:24:01'),
(3, 'cat', 'cat_3', '魚', '20171018055531_Banner2.png', '20171013114244_Banner07.jpg', '創業以来「安心・安全・満足」をモットーに、鮮魚専門店として鮮度・価格・味にこだわり、毎朝当社のバイヤーが市場で買い付けた新鮮な魚をお客様へ提供しております', '2017-10-26 12:20:24', '2017-10-26 06:20:24'),
(43, '', '', 'その他', '20171026122206_01005.jpg', '', 'その他の水産物', '2017-10-26 06:22:06', '2017-10-26 06:22:06');
...
(1, 'Logo', 'logo.png', '2017-10-26 11:16:12', '2017-10-26 05:16:12'),
...
(6, '<p><strong>ホクトウ水産</strong><br />\r\n東京都渋谷区幡ヶ谷2-7-6&nbsp; 3階<br />\r\n0120-55-3103</p>', 'bottom_thumbnail.png', '2017-10-25 08:08:03', '2017-10-25 02:08:03');
...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  `fname` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `mobile` int(20) NOT NULL,
  `message` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
...
(8, 'riad', 'rd', 'rdhawladar@gmail.com', 1, 'test mesag', '2017-10-24 06:17:51', '2017-10-24 06:17:51'),
(9, '', '', '', 0, '', '2017-10-24 06:17:56', '2017-10-24 06:17:56');
...
(1, 'cat', 'cat_1', '「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。', '<p>「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。</p>', '2017-10-30 03:24:08', '2017-10-29 21:24:08'),
(2, 'cat', 'cat_2', '「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。', '<p>「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。</p>', '2017-10-30 03:25:18', '2017-10-29 21:25:18'),
(3, 'cat', 'cat_3', '「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。', '<p>test catagory description 2 test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2test catagory description 2</p>', '2017-10-30 03:26:20', '2017-10-29 21:26:20'),
(4, '', '', '「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり', '<p>test new detilas</p>', '2017-10-30 03:26:58', '2017-10-29 21:26:58'),
(5, '', '', '「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人', '<p>server news etst</p>', '2017-10-30 03:27:14', '2017-10-29 21:27:14'),
(6, '', '', 'テストタイトル 「毛がに」は「ずわいがに」や「たらばがに」に比べ、味は濃厚で甘みがあり、たくさん入ったかにみそも人気のかにです。', '<p>いらっしゃいいらっしゃい</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>いらっしゃい</p>', '2017-10-30 03:25:45', '2017-10-29 21:25:45');
...
CREATE TABLE IF NOT EXISTS `other_page` (
  `id` int(11) NOT NULL,
...
(19, 1, 'cat_1', 'sub_11', 'ズワイ蟹', 6000, 0, '20171011095654_banner.jpg', '20171013114435_ズワイガニ.jpg', '冬のカニといえばズワイ蟹が有名。ボイルで脚やカニミソを食べたり、刺身にしてもおいしくいただけます。 山陰の日本海側で獲れたズワイガニを松葉蟹、福井県で獲れたズワイガニを越前ガニと呼ぶ。どちらも同じズワイガニですが、育った環境や餌が違うことで、それぞれ味が違う', '2017-10-24 06:14:40', '2017-10-24 00:14:40'),
(20, 1, 'cat_1', 'sub_12', '毛蟹', 0, 0, '20171011095523_banner.jpg', '20171013114531_毛蟹.jpg', '北海道で有名なケガニは濃厚なカニミソが絶品です。 太くてボリュームのある脚も、さまざまな料理に使われることが多い。', '2017-10-19 02:03:33', '2017-10-13 09:45:31'),
(21, 1, 'cat_1', 'sub_13', 'タラバ蟹', 0, 0, '20171011095538_banner.jpg', '20171013114654_タラバ蟹.jpg', '有名なタラバガニはヤドカリの仲間です。 ほとんどが輸入物でとても高級な蟹として知られています。 大きな脚は食べ応え充分。', '2017-10-19 02:03:33', '2017-10-13 09:46:54'),
(22, 2, 'cat_2', 'sub_21', 'いくら醤油漬', 0, 0, '20171012115324_Banner05.jpg', '20171013114751_いくら醤油漬.jpg', 'プチプチはじける食感と、シンプルで深い味わい。 佐藤水産のいくら醤油漬けは、北海道産天然鮭の生筋子からほぐしたものだけを使用しています。完熟前のまだ皮がやわらかいいくらを厳選しているため、味も染み込みやすく、皮が口の中に残らず食感が良いのが特徴です。独自に開発した「いくらほぐし洗浄機」を使ってやさしくほぐすいくらは、徹底した衛生管理を行っており、安全・安心。鮮度も大切にしています。ご家庭用として、さらには贈りものとして、鮭専門店ならではの本物のおいしさをぜひどうぞ。', '2017-10-19 02:03:33', '2017-10-13 09:47:51'),
(23, 2, 'cat_2', 'sub_22', 'すじ子', 0, 0, '20171012112608_Banner04.jpg', '20171013114821_すじ子.JPG', 'ちょっとリッチにそのまま食べても おいしい甘口のすじこ。 プチプチ食感がたまらなく、 より一層食欲をそそります。 大粒・小粒・切子からお選び下さい。', '2017-10-19 02:03:33', '2017-10-13 09:48:21'),
(24, 2, 'cat_2', 'sub_23', 'たらこ', 0, 0, '20171011065957_banner.jpg', '20171013114941_たらこ.jpg', '数の子ブランドとして認められている歴史あるヤマニ。実は、創業時の出発点は「たらこ」だったのです。その蓄積された知恵と経験が凝縮された「たらこ」と「辛子めんたいこ」。老舗ならではのよそでは真似できない味をご堪能ください。 お召し上がりになる場合にも、おすすめです。', '2017-10-19 02:03:33', '2017-10-13 09:49:41'),
(25, 3, 'cat_3', 'sub_31', 'きんき(きちじ)一夜干し', 0, 0, '20171012130111_Banner05.jpg', '20171013115100_きんき(きちじ)一夜干し.jpg', '太平洋・オホーツク海で漁獲されるきんき（きちじ）です。 身だけでなく皮にも脂があり、旨み・品・甘みのある 白身魚の王様と呼ばれるに値する超高級魚です。', '2017-10-19 02:03:33', '2017-10-13 09:51:00'),
(26, 3, 'cat_3', 'sub_32', 'サーモン刺身', 0, 0, '20171012130339_Banner04.jpg', '20171013115153_サーモン刺身.jpg', 'この刺身は一応、平造りに切ってますが、包丁を寝かせて刺身の形を整えています。だから、かなり我流の平作りと思ってください。普通は刺身の形が整わなくても、真っ直ぐ引いてることがおおいです。この辺は切る人、食べる人の好みでいいでしょうね。', '2017-10-19 02:03:33', '2017-10-13 09:51:53'),
(27, 3, 'cat_3', 'sub_33', 'Test', 0, 0, '20171011064756_banner.jpg', '20171011064756_20171010062522_Banner02.jpg', 'test', '2017-10-19 02:03:33', '2017-10-13 07:55:06'),
(29, 1, 'cat_1', 'sub_14', '花咲蟹', 0, 0, '20171011101037_banner.jpg', '20171013115304_花咲蟹.jpg', 'ゆでると花が咲いたように真っ赤になる人気のカニ。 こちらもタラバと同じくヤドカリの仲間です。 風味が強く、ファンが多いカニです。', '2017-10-19 02:03:33', '2017-10-13 09:53:04'),
(30, 2, 'cat_2', 'sub_24', '明太子', 0, 0, '20171011101100_banner.jpg', '20171013115412_明太子.jpg', 'しっとりとした食感の北海道産たらこを使用し、吟味を尽くした独自のたれに漬け込んだ、まるふじならではの辛子明太子です。 辛すぎず、辛さの中に甘みを感じる味わいが好評をいただいております。 ふっくらした粒子の食感と、たらこ本来の旨味と、ほどよい辛さをご堪能ください。', '2017-10-19 02:03:33', '2017-10-13 09:54:12'),
(31, 2, 'cat_2', 'sub_25', '味付け数の子', 0, 0, '20171011101122_banner.jpg', '20171013115912_味付け数の子.jpg', '数の子の色を生かした、白だし仕立て 味付けは材料2つでシンプル&簡単ですが、旨味たっぷりの味付けです。', '2017-10-19 02:03:33', '2017-10-13 09:59:12'),
(32, 2, 'cat_2', 'sub_26', '塩数の子', 0, 0, '20171011101135_banner.jpg', '20171013115951_塩数の子.jpg', '数の子は、卵の一つひとつに塩分がついているので、 水に浸けるだけでは塩抜きはできません。 理由は、浸透圧によるものです。 そのため数の子の塩抜きは、薄い塩水で行わないとうまくできません。', '2017-10-19 02:03:33', '2017-10-13 09:59:51'),
(33, 3, 'cat_3', 'sub_34', '時鮭', 0, 0, '20171011101430_banner.jpg', '20171013120043_時鮭.jpg', '産卵前の秋鮭とは違い、若く、脂ののった大変おいしい鮭です。 夏に北海道近海で水揚げされます。 焼き上がりも、ふっくらしていて、まさに初夏の味覚です。 大川魚店では、少量を真空包装して、姿切りで販売しております。是非ご利用ください。', '2017-10-19 02:03:33', '2017-10-13 10:00:43'),
(34, 3, 'cat_3', 'sub_35', '紅鮭姿', 0, 0, '20171011101456_banner.jpg', '20171013120114_紅鮭.jpg', '■商品内容					 ■内容量	1.5㎏～2.0㎏				 					 					 	※画像はイメージです。実際とは異なる場合があります				 					 					 ■原材料原産地	ロシア				 					 ■賞味期限					 ■配送方法	クール冷凍便				 ■ご注意	* 解凍後はお早めにお召し上がり下さい。　				 					 ●お召し上がり方					 					 					 ●紅鮭姿　1尾　1.5～2.0㎏			0', '2017-10-27 10:24:27', '2017-10-27 04:24:27'),
(35, 3, 'cat_3', 'sub_37', '真ホッケ開き一夜干し', 0, 0, '20171011101826_banner.jpg', '20171013120217_真ホッケ開き一夜干し.jpg', '新鮮な真ホッケを一夜干しに。ほどよい身のしまりとジューシーでありながら控えめな脂で、あっさりといただける干物です。', '2017-10-19 02:03:33', '2017-10-13 10:02:17'),
(36, 3, 'cat_3', 'sub_36', '縞ホッケ開き一夜干し', 0, 0, '20171011101852_banner.jpg', '20171013120300_縞ホッケ開き一夜干し.jpg', '肉厚でふっくらとした柔らかい身と抜群の脂のりが北海道ならでは。 北海の厳寒の海で育った魚たちは、身もしまり脂のりも抜群。 ジュッと脂の焼ける音が食欲をそそります。 肉厚な縞ホッケなので食べ応えあります。', '2017-10-19 02:03:33', '2017-10-13 10:03:00'),
(37, 43, '', '', '松前漬け 230ｇ', 1300, 100, '', '20171027051726_松前漬け.jpg', '北海道・道南産のスルメイカと真昆布を使用し、たっぷりの本数の子とあわせた贅沢な函館伝統の松前漬です。', '2017-10-26 23:17:26', '2017-10-26 23:17:26'),
(38, 43, '', '', '松前漬け 450ｇ', 2200, 100, '', '20171027052016_松前漬け450ｇ.jpg', '北海道・道南産のスルメイカと真昆布を使用し、たっぷりの本数の子とあわせた贅沢な函館伝統の松前漬です。', '2017-10-26 23:20:16', '2017-10-26 23:20:16'),
(39, 43, '', '', '早煮昆布 200g', 1300, 100, '', '20171027052632_早煮昆布.jpeg', '昆布の一番やわらかい春に採取した昆布です。短い時間で大変やわらかく煮上り、味も良くしみ、ご家庭料理には欠かせないこんぶです。 煮昆布専用として採ったもので煮しめ、昆布巻きの他野菜やお肉、お魚との煮合わせに最適です。水だけでも簡単にやわらかくなるコンブ！ 柔らかく、火が通りやすく、煮昆布として最適。 専用の棹を使い、通常より早く採取することから『棹前こんぶ』と呼ばれています。', '2017-10-27 05:46:05', '2017-10-26 23:46:05'),
(40, 43, '', '', '羅臼昆布 100g', 2600, 100, '', '20171027055133_羅臼昆布.jpg', '味か濃く、香りよい高級だし昆布 だしの良さで名高い羅臼昆布の最高級品。にごりがでないのでお吸い物やだし汁に最適です。昆布の表面には白い粉がついている事がありますが、汚れやカビではなく「マンニット」という旨み成分です。美容食として最高の『自然食』です。コンブは低カロリー、低脂肪でヘルシーな食品です。カロリー摂取の気になる方にうれしい食品です。水洗いしますと旨み成分が流れてしまいますので、乾いたふきん、又は固く絞った濡れふきんで表面を、汚れやゴミだけ落とす程度に軽く拭くようにして下さいね。こんぶは健康食。健康に必要な食物繊維やカルシウムがたっぷり！', '2017-10-27 05:57:16', '2017-10-26 23:57:16'),
(41, 43, '', '', '利尻昆布 150g', 1800, 100, '', '20171027062455_利尻昆布.jpg', '利尻昆布は澄んだ香りの良いだし汁がとれる高級昆布です。京都では千枚漬けや湯豆腐などに珍重されています。だしをとった後は、つくだ煮や煮物に使う他、おぼろ昆布とろろ昆布の加工用にも利用されています、北海道道北産天然利尻昆布は粘りもあり適度な塩味を含み澄んだ上品なだしがとれます。うどん屋さんや料亭などで広く使われており、鍋物やお吸い物に最適です。', '2017-10-27 06:27:15', '2017-10-27 00:27:15'),
(42, 43, '', '', 'とろろ昆布 500g', 2400, 100, '', '20171027062937_とろろ昆布.jpg', '北海道産昆布を削ったおいしいとろろ昆布です。お吸い物、うどんなどに！', '2017-10-27 00:29:37', '2017-10-27 00:29:37'),
(43, 43, '', '', '糠サンマ', 380, 100, '', '20171027063300_糠サンマ.jpg', '脂ののった新鮮な根室産のさんま 本品を自然解凍後、糠サンマを洗い流し、弱火でじっくりと焼いてお召し上がりください。', '2017-10-27 00:33:00', '2017-10-27 00:33:00'),
(44, 3, '', '', 'ナメタカレイ　一夜干し', 1200, 100, '', '20171027063655_ナメタカレイ　一夜干し.jpg', 'ぽってりと身が厚く、体が粘液でヌルヌルしているカレイですが一夜干しにするととても美味しい魚です。昔から安くておいしい魚として親しまれていますが、最近は漁獲が減り、高級魚扱いされるようになりました。網走で水揚げされた新鮮ななめたカレイを厳選して加工しました。焼き網・グリルで焼いて下さい。', '2017-10-27 00:36:55', '2017-10-27 00:36:55'),
(45, 43, '', '', '社長の塩辛 180g', 650, 100, '', '20171027090158_社長の塩辛カップ.jpg', '北海道産の真いかを使用し、絶妙な味付けを施したイチオシのいか塩辛がこの「社長のいか塩辛」です。商品名はその昔、社長が得意先回りの際に、手土産として使用していたのがその由来です。ネーミングがとっても面白い『社長のいか塩辛』です。函館近海の生いかと天然塩を使用した推薦の本格的な塩辛です。食べてみなけりゃ解らない！ 国産の真いかを使用し、絶妙な味付けを施したいか塩辛です。天然塩とゴロと呼ばれるいかの肝臓のまろやかで濃厚な味わいで、酒の肴にも、ごはんのお供にぴったり！何倍でもおかわりしたくなる美味しさです。', '2017-10-27 03:01:58', '2017-10-27 03:01:58'),
(46, 43, '', '', '社長の塩辛 250g', 860, 100, '', '20171027100013_社長の塩辛化粧箱.jpeg', '北海道産の真いかを使用し、絶妙な味付けを施したイチオシのいか塩辛がこの「社長のいか塩辛」です。 商品名はその昔、社長が得意先回りの際に、手土産として使用していたのがその由来です。 ネーミングがとっても面白い『社長のいか塩辛』です。 函館近海の生いかと天然塩を使用した推薦の本格的な塩辛です。食べてみなけりゃ解らない！ 国産の真いかを使用し、絶妙な味付けを施したいか塩辛です。 天然塩とゴロと呼ばれるいかの肝臓のまろやかで濃厚な味わいで、酒の肴にも、ごはんのお供にぴったり！何倍でもおかわりしたくなる美味しさです。', '2017-10-27 04:00:13', '2017-10-27 04:00:13'),
(47, 43, '', '', 'イカの一夜干し', 900, 100, '', '20171027102003_イカの一夜干し.jpg', 'イカ一夜干し。新鮮な真イカを厳選して加工処理した逸品。真いか特有の歯ごたえ、風味をご賞味下さい。ふっくら柔らかイカ一夜干しをお酒の肴に', '2017-10-27 04:20:03', '2017-10-27 04:20:03');
...
INSERT INTO `pro_order` (`id`, `order_id`, `product_id`, `name`, `email`, `address`, `mobile`, `quantity`, `price`, `status`, `created_at`, `updated_at`) VALUES
(22, 500, 8, '1', '3', '4', 2, 1, 200, 1, '2017-10-24 06:35:20', '2017-10-23 04:34:36'),
(42, 506, 20, 'riad', 'rdhawladar@gmail.com', 'sdfsdf', 938, 1, 0, 0, '2017-10-24 06:32:07', '2017-10-24 06:32:07'),
(43, 507, 19, 'rd', 'rdhawladar@gmail.com', 'rd', 1, 8, 6000, 0, '2017-10-27 02:13:29', '2017-10-27 02:13:29'),
(44, 507, 20, 'rd', 'rdhawladar@gmail.com', 'rd', 1, 2, 0, 0, '2017-10-27 02:13:29', '2017-10-27 02:13:29'),
(45, 507, 25, 'rd', 'rdhawladar@gmail.com', 'rd', 1, 5, 0, 0, '2017-10-27 02:13:29', '2017-10-27 02:13:29'),
(46, 508, 19, 'rd', 'rdhawladar@gmail.com', 'asdfasdf', 123123, 3, 18000, 0, '2017-10-27 02:47:33', '2017-10-27 02:47:33'),
(47, 508, 20, 'rd', 'rdhawladar@gmail.com', 'asdfasdf', 123123, 1, 0, 0, '2017-10-27 02:47:33', '2017-10-27 02:47:33');
...
CREATE TABLE IF NOT EXISTS `question_answer_requests` (
  `id` int(11) NOT NULL,
...
('f71d4085a5f5cd746952e6283ecd861f8bb83ff5', NULL, '114.134.91.94', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36', '', 1509359325, '');
...
CREATE TABLE IF NOT EXISTS `user_point_distribution` (
  `id` int(11) NOT NULL,
