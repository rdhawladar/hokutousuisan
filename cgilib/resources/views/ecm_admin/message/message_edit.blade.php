...
<!-- 	 				  <script>
					      location.href = "{{url('/admin/catagory-edit') }}";
					  </script>  -->
					@endif
					...
					<form role="form" method="post" enctype="multipart/form-data" action="{{ url('/admin/catagory-edit') }}">
					  {{  csrf_field() }}
						<div class="box-body">      
						    ...
						    <input type="hidden" name="old_catagory_thumbnail_url" value="{{ $topics->catagory_thumbnail_url }}" >
							...
							<div class="form-group">
							  ...
							  <input type="text" class="form-control" name="catagory_description" id="catagory_description" value="{{ $topics->catagory_description }}" placeholder=" catagory Description">
							</div>                                                    
                            ...
                            <div class="form-group">
							  ...
							  <img   controls="true" style="width:20%;max-width:600px;" src="{{ url('/ecm/catagory_img/'. $topics->catagory_thumbnail_url) }}"  >
							</div> 
