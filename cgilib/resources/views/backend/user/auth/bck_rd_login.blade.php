...
input::-webkit-input-placeholder {
  color: #636363;
    ...
    #loginpage{
        background:url('http://xn--u9j926gj4ecxa32lwx8cf56a.com/assets/dist/bg/waku1.png'); background-size:99% 125%;background-repeat:no-repeat;width:27%;height:77%; margin: 0 auto;
        position: relative;
...
<div  class="login-box">
 	...
 	<div class="login-box-body" id="loginpage" >
		...
		<form class = "form-cont" style="margin-top:-39px;" method="post" action="{{ url('/user/login') }}">
			{{ csrf_field() }}
			...
			<div class="row">
				<div class="col-xs-12">
				     ...
				     <table style="margin-top:-9px;" align="center">
				         <tr>
				         <td>
				            <input type="submit" value=""  style="border-left:0px solid #fff;border-right:0px solid #fff;border-top:0px solid #fff;border-bottom:0px solid #fff;width:100%;height:50px;background:url('http://xn--u9j926gj4ecxa32lwx8cf56a.com/assets/dist/bg/fgserrsr2.png') no-repeat;background-size:contain;background-position:45% 45%;" />
				         </td>
				         </tr>
				         <tr>
